package com.example.roommaker.app.categorias.examples.chat.controller;
...
import com.example.roommaker.app.categorias.examples.chat.controller.dto.MessageRequestWs;
import com.example.roommaker.app.categorias.examples.chat.core.Chat;
import com.example.roommaker.app.categorias.examples.chat.core.ChatManager;
import com.example.roommaker.app.categorias.examples.chat.core.Message;
...
public void chat(@DestinationVariable String usernameDono, @DestinationVariable String salaNome, @DestinationVariable String username) {
    ...
    public void setMessage(@Payload MessageRequestWs message, @DestinationVariable String usernameDono, @DestinationVariable String salaNome, @DestinationVariable String username) { //,@Header("simpSessionAttributes") Map<String, Object> sessionAttributes
        ...
        if(message.getMessage().length()>200){
            throw new ErroDeRequisicaoGeral("Mensagem não pode ter mais que 200 caracteres");
        }
